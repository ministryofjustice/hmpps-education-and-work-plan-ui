...
describe('educationAndTrainingTabContents', () => {
  const template = fs.readFileSync(
    'server/views/pages/overview/partials/educationAndTrainingTab/_educationAndTrainingTabWithoutInductionContents.njk',
  )
  ...
  it('should show data unavailable message if there is a problem retrieving education data', () => {
    // Given
    viewContext = { tab: 'education-and-training', education: { problemRetrievingData: true } }
