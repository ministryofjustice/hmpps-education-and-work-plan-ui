declare module 'educationAndWorkPlanApiClient' {
  ...
  export type SessionSearchResponses = components['schemas']['SessionSearchResponses']
  export type SessionSearchResponse = components['schemas']['SessionSearchResponse']
