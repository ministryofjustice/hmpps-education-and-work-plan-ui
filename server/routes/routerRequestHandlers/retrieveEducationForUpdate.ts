...
/**
 *  Middleware function that returns a Request handler function to retrieve the qualifications from EducationAndWorkPlanService and store in the prisoner context
