...
describe('archiveGoalFormToDtoMapper', () => {
  it('should map from form to DTO object', () => {
    ...
    const form: ArchiveGoalForm = { title: 'A goal', reference: goalReference, reason, reasonOther }
    const expected: ArchiveGoalDto = { prisonNumber, goalReference, reason, reasonOther }
  ...
  it('should map from DTO to request object with no other reason', () => {
    ...
    const expected: ArchiveGoalDto = { prisonNumber, goalReference, reason, reasonOther: undefined }
