...
const getDynamicBackLinkAriaText = (req: Request, backLinkUrl: string): string => {
  ...
  const ariaTextByUri: Record<string, string> = {
    ...
    '/prisoners/{PRISON_NUMBER}/create-induction/work-interest-types': `Back to What type of work is ${prisonerName} interested in?`,
    '/prisoners/{PRISON_NUMBER}/create-induction/work-interest-roles': `Back to Is ${prisonerName} interested in any particular jobs?`,
    ...
    '/prisoners/{PRISON_NUMBER}/create-induction/affect-ability-to-work': `Back to Is there anything that ${prisonerName} feels may affect their ability to work after they're released?`,
    ...
    '/prisoners/{PRISON_NUMBER}/induction/affect-ability-to-work': `Back to Is there anything that ${prisonerName} feels may affect their ability to work after they're released?`,
  }
