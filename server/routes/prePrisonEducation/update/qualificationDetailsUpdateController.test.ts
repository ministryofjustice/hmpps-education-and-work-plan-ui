...
describe('qualificationDetailsController', () => {
  ...
  describe('getQualificationDetailsView', () => {
    ...
    it('should redirect to Qualification Level page given there is no Qualification Level in the journey data', async () => {
      // Given
  ...
  describe('submitQualificationDetailsForm', () => {
    it('should redirect to Qualification List page', async () => {
      // Given
      const educationDto = {
        prisonNumber,
