...
context('Prisoner Overview page - Education And Training tab', () => {
  ...
  describe('should retrieve and render Functional Skills from Curious API data', () => {
    // Functional skills come from the Curious API /learnerAssessments/v2
    ...
    it('should display message saying no assessment scores for Maths and English are recorded given curious API returns a 404 for the learner assessments', () => {
      // Given
      cy.task('stubLearnerAssessments404Error') // Curious 404 for /learnerAssessments/v2 means there are no Functional Skills recorded for the prisoner
