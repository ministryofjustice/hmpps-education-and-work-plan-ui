...
// Original 'Add and edit a note' cypress tests disabled because the feature toggle to use the new Create Goal journey is enabled.
// These tests will be removed when the feature is complete and the feature toggle is removed.
context.skip('Add and edit a note', () => {
  beforeEach(() => {
    cy.task('reset')
